 ...
 * @version   1.3.0
 * @brief     Peripheral declarations for MK20DX32VLH5
 *
 * *****************************
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   3: ADC0_SE3             = ADC0_DP3(p11)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         ...
         /*  21: ADC0_SE21            = ADC0_DM3(p12)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
...
#define USBDM_ADC0_INFODP_IS_DEFINED
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            /*   1: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
            /*   2: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
            /*   3: ADC0_DP3             = ADC0_DP3(p11)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
      };
...
#define USBDM_ADC0_INFODM_IS_DEFINED
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            /*   1: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
            /*   2: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
            /*   3: ADC0_DM3             = ADC0_DM3(p12)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
      };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: VDD2                 = VDD2(p30)                      */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   3: VDD3                 = VDD3(p48)                      */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   4: VDDA                 = VDDA(p13)                      */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   5: VOUT33               = VOUT33(p7)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   6: VREFH                = VREFH(p14)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   7: VREFL                = VREFL(p15)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   8: VREGIN               = VREGIN(p8)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   9: VSS1                 = VSS1(p4)                       */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*  10: VSS2                 = VSS2(p31)                      */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*  11: VSS3                 = VSS3(p47)                      */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*  12: VSSA                 = VSSA(p16)                      */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
   };
