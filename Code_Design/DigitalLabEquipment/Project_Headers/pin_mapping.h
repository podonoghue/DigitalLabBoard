...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: GPIOB_2              = PTB2(p29)                      */  { PortBInfo,  2,            (PcrValue)0x00100UL  },
         /*   3: GPIOB_3              = PTB3(p30)                      */  { PortBInfo,  3,            (PcrValue)0x00100UL  },
   ...
   PORTB->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x000CUL);
   ...
   PORTB->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x000CUL);
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: GPIOC_2              = PTC2(p35)                      */  { PortCInfo,  2,            (PcrValue)0x00100UL  },
         /*   3: GPIOC_3              = PTC3(p36)                      */  { PortCInfo,  3,            (PcrValue)0x00100UL  },
         /*   4: GPIOC_4              = PTC4(p37)                      */  { PortCInfo,  4,            (PcrValue)0x00100UL  },
         /*   5: GPIOC_5              = PTC5(p38)                      */  { PortCInfo,  5,            (PcrValue)0x00100UL  },
         /*   6: GPIOC_6              = PTC6(p39)                      */  { PortCInfo,  6,            (PcrValue)0x00100UL  },
         /*   7: GPIOC_7              = PTC7(p40)                      */  { PortCInfo,  7,            (PcrValue)0x00100UL  },
   ...
   PORTC->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x00FFUL);
   }
...
public:
   ...
   PORTD->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x00DFUL);
   }
   ...
   PORTD->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x00DFUL);
   }
...
public:
   ...
   static constexpr uint32_t cr = 
      ...
      RTC_CR_CLKO(1) | // Enable RTC 32kHz Clock Output - Clock not output to peripherals
 ...
 */
    ...
    */
   enum OscMode {
      OscMode_ExternalClock       = MCG_C2_EREFS0(0)|MCG_C2_HGO0(0), ///< External clock
      OscMode_LowPowerOscillator  = MCG_C2_EREFS0(1)|MCG_C2_HGO0(0), ///< Low Power Oscillator
...
public:
   ...
   static uint32_t getExternalReferenceClock() {
      ...
      switch(mcg->C7&MCG_C7_OSCSEL_MASK) {
         ...
         case McgErcSelect_RtcClk : return RtcInfo::getInternalClock(); ///< RTC 32kHz clock
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   5: FTM0_CH5             = PTD5(p46)                      */  { PortDInfo,  5,            (PcrValue)0x00400UL  },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: I2C0_SCL             = PTB0(p27)                      */  { PortBInfo,  0,            (PcrValue)0x00220UL  },
         /*   1: I2C0_SDA             = PTB1(p28)                      */  { PortBInfo,  1,            (PcrValue)0x00220UL  },
   };
   ...
   PORTB->GPCLR = 0x0220UL|PORT_GPCLR_GPWE(0x0003UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   8: LLWU_P8              = PTC4(p37)                      */  { PortCInfo,  4,            (PcrValue)0x00100UL  },
   ...
   PORTA->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0010UL);
   PORTC->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x007AUL);
   PORTD->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0055UL);
   }
...
public:
   ...
   public:
       ...
       * @param    rest
       *
       * @param pitChannelNum Select a PIT channel
       */
      template <typename... Types>
...
///  -------------- | ------------------------------|--------------------------------------------------- | ------------------------- | ----------------------------------------------------
///  ADC0_DP0       | JtagVref                      | ADC0_SE0                                           | p7                        | Used to measure JTAG Vref
///  EXTAL32        | -                             | EXTAL32                                            | p15                       | Unused
///  PIT_CH0        | MotorPitChannel               | PIT_CH0                                            | Internal                  | Motor simulator - PIT channel
///  PIT_CH1        | ButtonPollChannel             | PIT_CH1                                            | Internal                  | Used to poll directly connected buttons - power, clock and traffic
///  PTA0           |                               | SWD_CLK                                            | p17                       | SWD_CLK
///  PTA1           | -                             | UART0_RX                                           | p18                       | SWD_Rx
///  PTA2           | -                             | UART0_TX                                           | p19                       | SWD_Tx
///  PTA3           |                               | SWD_DIO                                            | p20                       | SWD_DIO
///  PTA4           | PowerButton                   | GPIOA_4                                            | p21                       | Power toggle button
///  PTA18          | -                             | EXTAL0                                             | p24                       | 16 MHz Crystal
///  PTA19          | -                             | XTAL0                                              | p25                       | 16 MHz Crystal
///  PTB0           | -                             | I2C0_SCL                                           | p27                       | I2C_SCL
///  PTB1           | -                             | I2C0_SDA                                           | p28                       | I2C_SDA
///  PTB2           | Debug                         | GPIOB_2                                            | p29                       | Debug pin
///  PTB3           | PowerEnableControl            | GPIOB_3                                            | p30                       | Power - Enable to voltage regulator
///  PTB16          | FrequencyButtons/FrequencyDownButton| GPIOB_16                                           | p31                       | Frequency generator - Up/Down buttons
///  PTB17          | FrequencyButtons/FrequencyUpButton| GPIOB_17                                           | p32                       | Frequency generator - Up/Down buttons
///  PTC0           | CharliePlexing                | GPIOC_0                                            | p33                       | Motor simulator - Charlieplexed LEDs
///  PTC1           | CharliePlexing                | GPIOC_1                                            | p34                       | Motor simulator - Charlieplexed LEDs
///  PTC2           | CharliePlexing                | GPIOC_2                                            | p35                       | Motor simulator - Charlieplexed LEDs
///  PTC3           | CharliePlexing                | GPIOC_3                                            | p36                       | Motor simulator - Charlieplexed LEDs
///  PTC4           | MotorPhases                   | GPIOC_4                                            | p37                       | Motor simulator - Phase inputs from user
///  PTC5           | MotorPhases                   | GPIOC_5                                            | p38                       | Motor simulator - Phase inputs from user
///  PTC6           | MotorPhases                   | GPIOC_6                                            | p39                       | Motor simulator - Phase inputs from user
///  PTC7           | MotorPhases                   | GPIOC_7                                            | p40                       | Motor simulator - Phase inputs from user
///  PTD0           | TrafficButtons/Jtag/Tck/carNS | GPIOD_0                                            | p41                       | Traffic Intersection/JTAG interface/JTAG - TCK/CAR_NS
///  PTD1           | TrafficButtons/Jtag/Tdo/carEW | GPIOD_1                                            | p42                       | //JTAG - TDO/CAR_EW
///  PTD2           | TrafficButtons/Jtag/Tdi/pedNS | GPIOD_2                                            | p43                       | //JTAG - TDI/PED_NS
///  PTD3           | TrafficButtons/Jtag/Tms/pedEW | GPIOD_3                                            | p44                       | //JTAG - TMS/PED_EW
///  PTD4           | ProgrammerPassLed             | GPIOD_4                                            | p45                       | Programmer Pass LED (Green)
///  PTD5           | FrequencyGeneratorTimerChannel| FTM0_CH5                                           | p46                       | Frequency generator channel
///  PTD6           | TargetVddSample               | ADC0_SE7b                                          | p47                       | Used to measure Target Vdd
///  PTD6           | TargetVddDischarge            | GPIOD_6                                            | p47                       | Used to discharge TargetVdd (against leakage)
///  PTD7           | ProgrammerFailLed             | GPIOD_7                                            | p48                       | Programmer Fail LED (Red)
