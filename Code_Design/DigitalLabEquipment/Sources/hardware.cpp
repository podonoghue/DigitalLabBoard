 ...
 * @version   1.2.0
 * @brief     Pin initialisation for MK20DN128VLF5
 *
 * *****************************
...
void mapAllPins() {
      ...
      PORTC->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x00FBUL);
      PORTD->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x001FUL);
      PORTD->GPCLR = 0x0400UL|PORT_GPCLR_GPWE(0x00C0UL);
}
/** 
